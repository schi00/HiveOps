...
{
    private readonly string _databaseName = $"SaaSBot_Integration_{Guid.NewGuid():N}";
    ...
    private static void Seed(AppDbContext db)
    {
        ...
        db.AppUsers.AddRange(
            ...
            new AppUser
            {
                ...
                Email = "tenant_alpha@saasbot.local",
                PasswordHash = PasswordSecurity.HashPassword("123456"),
                Role = "Tenant",
                TenantId = alphaId,
                IsActive = true
            ...
            new AppUser
            {
                ...
                Email = "tenant_beta@saasbot.local",
                PasswordHash = PasswordSecurity.HashPassword("123456"),
                Role = "Tenant",
                TenantId = betaId,
                IsActive = true
        ...
        db.Conversations.AddRange(
            new Conversation { Id = alphaConversationId, TenantId = alphaId, Channel = "whatsapp", ChannelUserId = "alpha-user", Status = SaaSBot.Domain.Enums.ConversationStatus.Active },
            new Conversation { Id = betaConversationId, TenantId = betaId, Channel = "whatsapp", ChannelUserId = "beta-user", Status = SaaSBot.Domain.Enums.ConversationStatus.Active },
            new Conversation { Id = alphaInteractiveConversationId, TenantId = alphaId, Channel = "whatsapp", ChannelUserId = "5491155517000", Status = SaaSBot.Domain.Enums.ConversationStatus.Active });

        db.Orders.AddRange(
            new Order { Id = Guid.Parse("aaaaaaaa-1111-1111-1111-111111111111"), TenantId = alphaId, ConversationId = alphaConversationId, CustomerPhone = "+54911", CustomerName = "Alpha Buyer", Status = SaaSBot.Domain.Enums.OrderStatus.Confirmed, TotalAmount = 150 },
            new Order { Id = Guid.Parse("bbbbbbbb-1111-1111-1111-111111111111"), TenantId = betaId, ConversationId = betaConversationId, CustomerPhone = "+54922", CustomerName = "Beta Buyer", Status = SaaSBot.Domain.Enums.OrderStatus.Confirmed, TotalAmount = 105 },
            new Order { Id = alphaDraftOrderId, TenantId = alphaId, ConversationId = alphaInteractiveConversationId, CustomerPhone = "+549117000", CustomerName = "Alpha Interactive", Status = SaaSBot.Domain.Enums.OrderStatus.Draft, TotalAmount = 0 });
