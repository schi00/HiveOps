...
public sealed class SmtpEmailService : IEmailService
{
    ...
    public async Task SendPasswordResetEmailAsync(string toEmail, string userName, string resetLink, CancellationToken ct = default)
    {
        ...
        var fromName = section["FromName"] ?? "SaaSBot";
...
#pragma warning restore CA5336
        ...
        var body = $"""
            ...
            Recibimos una solicitud para restablecer la contraseña de tu cuenta en SaaSBot.
        ...
        using var message = new MailMessage
        {
            ...
            Subject = "Restablecé tu contraseña — SaaSBot",
            Body = body,
            IsBodyHtml = false
        };
